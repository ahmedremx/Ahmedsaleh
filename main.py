...
from cpmflankertool import CPMFLankertool
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - t.me/QQlQHQ"
    colors = [
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = CPMFLankertool(acc_access_key)
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '===============[ POPS☆ ]==============='))
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, '======================================'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: In order to tweak this account with CPMFLankertool.'))
